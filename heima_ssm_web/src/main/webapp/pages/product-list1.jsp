                    ...
                    <div class="box-body">
                        ...
                        <div class="table-box">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <c:forEach var="prodouct" items="${productList}">
                                    <tr>
                                        <td><input name="ids" type="checkbox"></td>
                                        <td>${prodouct.id}</td>
                                        <td>${prodouct.productNum}</td>
                                        <td>${prodouct.productName}</td>
                                        <td>${prodouct.cityName}</td>
                                        <td>${prodouct.departureTimeStr}</td>
                                        <td class="text-center">${prodouct.productPrice}</td>
                                        <td class="text-center">${prodouct.productDesc}</td>
                                        <td class="text-center">${prodouct.productStatusStr}</td>
